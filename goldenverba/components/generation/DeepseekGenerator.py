...
class DeepseekGenerator(GPT4Generator):
    """
    Deepseek Generator.
    """
    ...
    async def generate_stream(
        ...
        try:
            ...
            openai.api_base = self.deepseek_base_url
            
            debug_log("deepseekGenerator : generate_stream",openai.api_key)
            debug_log("deepseekGenerator : base url",openai.api_base )
            debug_log("deepseekGenerator : API Type:", openai.api_type)
            debug_log("deepseekGenerator : API Version:", openai.api_version)
