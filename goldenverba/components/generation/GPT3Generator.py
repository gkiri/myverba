...
class GPT3Generator(GPT4Generator):
    ...
    def __init__(self):
        ...
        info_log("MODEL :: gpt-3.5-turbo-0125")
    ...
    async def generate_stream(
        ...
        try:
            ...
            debug_log("GPT3Generator : generate_stream",openai.api_key)
            debug_log("GPT3Generator : base url",openai.api_base )
            debug_log("GPT3Generator : API Type:", openai.api_type)
            debug_log("GPT3Generator : API Version:", openai.api_version)
