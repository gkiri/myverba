...
class GPT4Generator(Generator):
    ...
    async def generate_stream(
        ...
        try:
            ...
            debug_log("GPT4Generator : generate_stream",openai.api_key)
            debug_log("GPT4Generator : base url",openai.api_base )
            debug_log("GPT4Generator : API Type:", openai.api_type)
            debug_log("GPT4Generator : API Version:", openai.api_version)
