...
const DocumentComponent: React.FC<DocumentComponentProps> = ({
  ...
  const renderFeatureContent = () => {
    ...
    const commonClasses = "bg-white rounded-lg p-6 shadow-lg prose prose-verba max-w-none";
  ...
  if (currentDocument !== null && !isFetching) {
    return (
      <div className="flex flex-col bg-white rounded-lg shadow-lg p-5 text-text-verba gap-5 h-full overflow-auto">
        {/*Title*/}
  ...
  if (!currentDocument && !featureContent && !isFetching) {
    return (
      <div className="flex flex-col bg-white rounded-lg shadow-lg p-5 text-text-verba h-full overflow-auto">
