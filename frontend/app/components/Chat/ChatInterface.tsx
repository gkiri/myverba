...
return (
  <Card className="flex flex-col h-[calc(100vh-8rem)] my-3 bg-gradient-to-br from-indigo-50 to-blue-100 dark:from-gray-900 dark:to-indigo-900 shadow-2xl rounded-xl overflow-hidden">
