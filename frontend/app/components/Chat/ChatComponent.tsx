...
const ChatComponent: React.FC<ChatComponentProps> = ({
  ...
  return (
    <div className="flex sm:flex-col md:flex-row justify-between items-stretch md:gap-3 h-full w-full">
      ...
      <div className="flex lg:flex-row sm:flex-col justify-between items-start sm:w-full md:w-1/2 lg:w-4/6 gap-3 h-full">
        <div className="sm:w-full md:w-1/3 lg:w-1/5 flex flex-col gap-2 mb-auto">
          <ChunksComponent
            context={context}
            production={production}
            chunks={chunks}
        ...
        <div className="sm:w-full lg:w-4/5 flex flex-col gap-2 h-full mb-auto">
          <DocumentComponent
            production={production}
            setSelectedChunk={setSelectedChunk}
            selectedChunk={selectedChunk}
