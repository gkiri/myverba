...
const AddMocksPage: React.FC<AddMocksPageProps> = ({ APIHost, settingConfig }) => {
  ...
  const handleUpload = async () => {
    ...
    try {
      ...
      const response = await fetch(APIHost + '/api/upload_mock_exam', {
        method: 'POST',
        body: formData,
        // onUploadProgress: (progressEvent) => {  // Uncomment for progress bar 
